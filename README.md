About opentelemetry-exporter-zipkin-proto-http-feedstock
========================================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/opentelemetry-exporter-zipkin-proto-http-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/opentelemetry-exporter-zipkin-proto-http-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add opentelemetry-exporter-zipkin-proto-http
# for installing globally
pixi global install opentelemetry-exporter-zipkin-proto-http
```
...
It is possible to list all of the versions of `opentelemetry-exporter-zipkin-proto-http` available on your platform:
...
```
pixi search opentelemetry-exporter-zipkin-proto-http --channel conda-forge
```
